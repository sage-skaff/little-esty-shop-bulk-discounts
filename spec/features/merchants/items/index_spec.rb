...
RSpec.describe 'merchant items index' do
  ...
  it 'displays the top sales date for a each item next' do
    ...
    invoiceitem1_item1_invoice1 = InvoiceItem.create!(item_id: item1_merchant1.id, invoice_id: invoice1.id,
                                                      quantity: 10, unit_price: 1, status: 0)
    invoiceitem2_item1_invoice1 = InvoiceItem.create!(item_id: item1_merchant1.id, invoice_id: invoice1.id,
                                                      quantity: 10, unit_price: 1, status: 0)

    transaction1 = Transaction.create!(invoice_id: invoice1.id, credit_card_number: 2_222_333_344_445_555, credit_card_expiration_date: '05-19-1992', result: 1) # successful
    ...
    invoiceitem1_item1_invoice2 = InvoiceItem.create!(item_id: item1_merchant1.id, invoice_id: invoice2.id,
                                                      quantity: 10, unit_price: 1, status: 0)
    invoiceitem2_item1_invoice2 = InvoiceItem.create!(item_id: item1_merchant1.id, invoice_id: invoice2.id,
                                                      quantity: 10, unit_price: 1, status: 0)
    invoiceitem2_item1_invoice2 = InvoiceItem.create!(item_id: item1_merchant1.id, invoice_id: invoice2.id,
                                                      quantity: 10, unit_price: 1, status: 0)

    transaction2 = Transaction.create!(invoice_id: invoice2.id, credit_card_number: 2_222_333_344_445_555, credit_card_expiration_date: '05-19-1992', result: 1) # successful
    ...
    invoiceitem1_item1_invoice3 = InvoiceItem.create!(item_id: item1_merchant1.id, invoice_id: invoice3.id,
                                                      quantity: 1000, unit_price: 1, status: 0)

    transaction2 = Transaction.create!(invoice_id: invoice3.id, credit_card_number: 2_222_333_344_445_555, credit_card_expiration_date: '05-19-1992', result: 0) # failed transaction

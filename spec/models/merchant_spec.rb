  ...
  describe 'class methods' do
    ...
    it 'returns all associated enabled items' do
      ...
      item1_merchant1 = Item.create!(name: 'Snake Pants', description: 'It is just a sock.', unit_price: 400,
                                     merchant_id: merchant1.id, status: 'Enabled')
      item2_merchant1 = Item.create!(name: 'Stinky Bits', description: 'Nondescript floaty chunks.', unit_price: 200,
                                     merchant_id: merchant1.id, status: 'Disabled')
      item3_merchant1 = Item.create!(name: 'Fur Ball', description: 'Ew pretty nasty!', unit_price: 1000,
                                     merchant_id: merchant1.id, status: 'Enabled')
    ...
    it 'returns all associated disabled items' do
      ...
      item3_merchant1 = Item.create!(name: 'Fur Ball', description: 'Ew pretty nasty!', unit_price: 1000,
                                     merchant_id: merchant1.id, status: 'Enabled')
      item4_merchant1 = Item.create!(name: 'Big Chips', description: 'Yum yum!', unit_price: 1000,
                                     merchant_id: merchant1.id, status: 'Disabled')
